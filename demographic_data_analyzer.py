...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country_percentage = (country_rich_count / country_total_count * 100).max()
    highest_earning_country = (country_rich_count / country_total_count * 100).idxmax()
